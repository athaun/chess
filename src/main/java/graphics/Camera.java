...
public class Camera {
    ...
    public void smoothFollow(Vector2f c) {
        ...
        // smoothedPosition.x = (float) Math.floor((smoothedPosition.x + 0.5f));
        // smoothedPosition.y = (float) Math.floor((smoothedPosition.y + 0.5f));
        // smoothedPosition.x = Math.round(smoothedPosition.x);
        // smoothedPosition.y = Math.round(smoothedPosition.y);
